...
export const hiLocale = {
  ...
  registrationAskAddress:
    "धन्यवाद। **आपका शहर या पता क्या है?** (जैसे: नागपुर, वर्धा, अमरावती, चंद्रपुर)",
  ...
  faqOptions: [
    ...
    { id: 'faq_centers', label: 'आपका केंद्र कहाँ स्थित है?', payload: 'faq_centers' },
    { id: 'faq_back', label: 'मुख्य मेन्यू पर जाएँ', payload: 'back_to_menu' }
  ] as QuickReply[],

  faqCentersText:
    "### Mitrangan पुनर्वास केंद्र परिसर\n- **नागपुर केंद्र:** Plot no. 7, Manasvi Multi-speciality hospital, Khangar layout, opposite Satyam Garden, Godhani, Nagpur - 441123, महाराष्ट्र (हेल्पलाइन: +91 9767362388)\n\nहमारे केंद्र में शांत हरा-भरा वातावरण, 24 घंटे मेडिकल देखरेख, सीसीटीवी सुरक्षा, पौष्टिक भोजन और अनुशासित दिनचर्या उपलब्ध है।",
