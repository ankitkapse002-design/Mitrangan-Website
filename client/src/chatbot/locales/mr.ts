...
export const mrLocale = {
  ...
  welcomeMessage:
    "Mitrangan De-Addiction & Rehabilitation Center मध्ये आपले स्वागत आहे।\n\nनमस्कार, मी आशा आहे. मी तुम्हाला व्यसनमुक्ती, पुनर्वसन, प्रवेश प्रक्रिया आणि पुढील पायरी समजून घेण्यास मदत करू शकतो.\n\nतुम्ही स्वतःसाठी मदत शोधत आहात, की कुटुंबातील कोणासाठी?",
  inputPlaceholder: 'आशाला काहीही विचारा (प्रवेश, उपचार, मदत)...',
  typingIndicator: 'आशा टाईप करत आहेत...',
  sendButton: 'पाठवा',
  ...
  registrationAskAddress:
    "धन्यवाद. **तुमचे शहर किंवा पत्ता काय आहे?** (उदा. नागपूर, वर्धा, अमरावती, चंद्रपूर)",
  ...
  faqCentersText:
    "### Mitrangan पुनर्वसन केंद्र परिसर\n- **नागपूर केंद्र:** Plot no. 7, Manasvi Multi-speciality hospital, Khangar layout, opposite Satyam Garden, Godhani, Nagpur - 441123, महाराष्ट्र (हेल्पलाईन: +91 9767362388)\n\nआमच्या केंद्रामध्ये शांत व निसर्गरम्य परिसर, २४ तास डॉक्टरांची देखरेख, सीसीटीव्ही सुरक्षा, सकस आहार आणि शिस्तबद्ध दिनचर्या उपलब्ध आहे.",
